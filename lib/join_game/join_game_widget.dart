                        ...
                        Padding(
                          ...
                          child: StreamBuilder<List<GamesRecord?>>(
                            stream: queryGamesRecord(
                              queryBuilder: (gamesRecord) => gamesRecord.where('code', isEqualTo: widget.gameCode),
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              ...
                              List<GamesRecord?>? buttonGamesRecordList = snapshot.data;
                              // Return an empty Container when the document does not exist.
                              if (snapshot.data?.isEmpty ?? true) {
                                return Container();
                              }
                              final buttonGamesRecord =
                                  buttonGamesRecordList?.isNotEmpty ?? false ? buttonGamesRecordList?.first : null;
                              return FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await buttonGamesRecord?.reference?.update(gamesUpdateData);
