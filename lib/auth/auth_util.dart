...
bool get currentUserEmailVerified {
  ...
  if (currentUser?.user != null && !(currentUser?.user?.emailVerified ?? false)) {
...
DocumentReference? get currentUserReference =>
    currentUser?.user != null ? UsersRecord.collection.doc(currentUser?.user?.uid) : null;
...
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap((uid) => queryUsersRecord(queryBuilder: (user) => user.where('uid', isEqualTo: uid), singleRecord: true))
