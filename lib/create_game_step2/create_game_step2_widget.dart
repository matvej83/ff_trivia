                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              Builder(
                                builder: (context) {
                                  final categories = widget.gameRecord.categories?.toList() ?? [];
                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                      ...
                                      return Padding(
                                        ...
                                        child: FutureBuilder<ApiCallResponse?>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final textCategoryResponse = snapshot.data;
                                            return Text(
                                              getJsonField(textCategoryResponse?.jsonBody, r'''$.title''').toString(),
                                              style: FlutterFlowTheme.bodyText1,
                                            );
                                          },
                                        ),
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    final gameScoresCreateData = createGameScoresRecordData(
                                      user: currentUserReference,
                                      game: widget.gameRecord.reference,
                                      score: 0,
                                    );
                                    await GameScoresRecord.collection.doc().set(gameScoresCreateData);
                                    await Navigator.pushAndRemoveUntil(
                                      context,
                                      PageTransition(
