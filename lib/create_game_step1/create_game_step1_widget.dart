                            ...
                            child: FutureBuilder<ApiCallResponse?>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return Builder(
                                  builder: (context) {
                                    final categories =
                                        getJsonField(columnGetCategoriesResponse?.jsonBody, r'''$''')?.toList() ?? [];
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: Text(
                                                      getJsonField(categoriesItem, r'''$.title''').toString(),
                                                  ...
                                                  Row(
                                                    mainAxisSize: MainAxisSize.max,
                                                    children: [
                                                      if (!(containerGamesRecord?.categories
                                                              ?.contains(getJsonField(categoriesItem, r'''$.id''')) ??
                                                          false))
                                                        InkWell(
                                                          onTap: () async {
                                                            final gamesUpdateData = {
                                                              'categories': FieldValue.arrayUnion(
                                                                  [getJsonField(categoriesItem, r'''$.id''')]),
                                                            };
                                                            await widget.gameRecord.reference?.update(gamesUpdateData);
                                                          },
                                                          child: Icon(
                                ...
                                await Navigator.push(
                                  ...
                                  PageTransition(
                                    ...
                                    child: CreateGameStep1Widget(
                                      ...
                                      categoryOffset: functions.generateRandomOffset(),
                                    ),
                                  ),
                                );
                              },
